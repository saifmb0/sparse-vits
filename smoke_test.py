...
def test_evit_pytorch():
    print("Testing EViT + PyTorch Padded pipeline...")
...
def test_evit_triton():
    print("Testing EViT + Triton Ragged pipeline...")
...
def test_tome_pytorch():
    print("Testing ToMe + PyTorch pipeline...")
